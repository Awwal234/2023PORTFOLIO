...
<template>
    <div
        ...
        <div class="w-full md:w-[50%] lg:w-[30%]">
            <div class="w-fit h-fit"><img src="/img/soilit.png" class="" alt="" /></div>
        ...
        <div class="w-full md:w-[50%] lg:w-[25%]">
            <div
                class="font-[600] mx-auto md:mx-[0px] text-center text-[#221115] md:text-[48px] text-[48px] leading-[60.48px]">
        ...
        <div class="w-full md:hidden lg:w-[30%] lg:block">
            <div class="w-fit h-fit"><img src="/img/umbrellas.png" class="" alt="" /></div>
...
.line {
    ...
    background-image: linear-gradient(to right, #dddddd, #f2f2f2);
}
</style>